package silptech.developerabhi.silpbutton;
...
public class SilpCustomButton extends LinearLayout {
     ...
     */
    public SilpCustomButton(Context context) {
        super(context);
     ...
     */
    public SilpCustomButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.mContext = context;

        TypedArray attrsArray = context.obtainStyledAttributes(attrs, R.styleable.SilpCustomButtonAttrs, 0, 0);
     ...
     */
    private void initializeSilpCustomButton() {
    ...
    private void initAttributesArray(TypedArray attrsArray) {
        ...
        mDefaultBackgroundColor = attrsArray.getColor(R.styleable.SilpCustomButtonAttrs_scb_defaultColor, mDefaultBackgroundColor);
        mFocusBackgroundColor = attrsArray.getColor(R.styleable.SilpCustomButtonAttrs_scb_focusColor, mFocusBackgroundColor);
        mDisabledBackgroundColor = attrsArray.getColor(R.styleable.SilpCustomButtonAttrs_scb_disabledColor, mDisabledBackgroundColor);

        mEnabled = attrsArray.getBoolean(R.styleable.SilpCustomButtonAttrs_android_enabled, true);

        mDisabledTextColor = attrsArray.getColor(R.styleable.SilpCustomButtonAttrs_scb_disabledTextColor, mDisabledTextColor);
        mDisabledBorderColor = attrsArray.getColor(R.styleable.SilpCustomButtonAttrs_scb_disabledBorderColor, mDisabledBorderColor);
        mDefaultTextColor = attrsArray.getColor(R.styleable.SilpCustomButtonAttrs_scb_textColor, mDefaultTextColor);
        // if default color is set then the icon's color is the same (the default for icon's color)
        mDefaultIconColor = attrsArray.getColor(R.styleable.SilpCustomButtonAttrs_scb_iconColor, mDefaultTextColor);

        mDefaultTextSize = (int) attrsArray.getDimension(R.styleable.SilpCustomButtonAttrs_scb_textSize, mDefaultTextSize);
        mDefaultTextSize = (int) attrsArray.getDimension(R.styleable.SilpCustomButtonAttrs_android_textSize, mDefaultTextSize);

        mDefaultTextGravity = attrsArray.getInt(R.styleable.SilpCustomButtonAttrs_scb_textGravity, mDefaultTextGravity);

        mBorderColor = attrsArray.getColor(R.styleable.SilpCustomButtonAttrs_scb_borderColor, mBorderColor);
        mBorderWidth = (int) attrsArray.getDimension(R.styleable.SilpCustomButtonAttrs_scb_borderWidth, mBorderWidth);

        mRadius = (int) attrsArray.getDimension(R.styleable.SilpCustomButtonAttrs_scb_radius, mRadius);
        mFontIconSize = (int) attrsArray.getDimension(R.styleable.SilpCustomButtonAttrs_scb_fontIconSize, mFontIconSize);

        mIconPaddingLeft = (int) attrsArray.getDimension(R.styleable.SilpCustomButtonAttrs_scb_iconPaddingLeft, mIconPaddingLeft);
        mIconPaddingRight = (int) attrsArray.getDimension(R.styleable.SilpCustomButtonAttrs_scb_iconPaddingRight, mIconPaddingRight);
        mIconPaddingTop = (int) attrsArray.getDimension(R.styleable.SilpCustomButtonAttrs_scb_iconPaddingTop, mIconPaddingTop);
        mIconPaddingBottom = (int) attrsArray.getDimension(R.styleable.SilpCustomButtonAttrs_scb_iconPaddingBottom, mIconPaddingBottom);

        mTextAllCaps = attrsArray.getBoolean(R.styleable.SilpCustomButtonAttrs_scb_textAllCaps, false);
        mTextAllCaps = attrsArray.getBoolean(R.styleable.SilpCustomButtonAttrs_android_textAllCaps, false);

        mGhost = attrsArray.getBoolean(R.styleable.SilpCustomButtonAttrs_scb_ghost, mGhost);
        mUseSystemFont = attrsArray.getBoolean(R.styleable.SilpCustomButtonAttrs_scb_useSystemFont, mUseSystemFont);

        String text = attrsArray.getString(R.styleable.SilpCustomButtonAttrs_scb_text);

        if (text == null) { //no fb_text attribute
            text = attrsArray.getString(R.styleable.SilpCustomButtonAttrs_android_text);
        }

        mIconPosition = attrsArray.getInt(R.styleable.SilpCustomButtonAttrs_scb_iconPosition, mIconPosition);

        String fontIcon = attrsArray.getString(R.styleable.SilpCustomButtonAttrs_scb_fontIconResource);

        String iconFontFamily = attrsArray.getString(R.styleable.SilpCustomButtonAttrs_scb_iconFont);
        String textFontFamily = attrsArray.getString(R.styleable.SilpCustomButtonAttrs_scb_textFont);

        Drawable icon = null;
        try {
            mIconResource = attrsArray.getDrawable(R.styleable.SilpCustomButtonAttrs_scb_iconResource);
